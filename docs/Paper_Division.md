...
_Focus: Long-range structures, new technologies, and handling sparse data._
...
3.  **[7] Hewage et al.** — Comprehensive analysis of the 3-phase promo lifecycle.
...
_Focus: Feature signal, external drivers (Oil), and temporal attention._
...
_Focus: Promotional lift, spatial relations, and model stability/validation._
...
6.  **[18] Y. Liu et al.** — Analyzing the effectiveness of Transformers vs. Linear.
...
To maximize the value of these readings, members should meet at the following "Technical Intersection" points:

- **The Promotional Task Force (A-7, B-5, B-8, C-3, C-6):** Meet to finalize the definitions for FR-08 (Cannibalization proxy features).
- **The XAI Workshop (A-16, B-14, C-15):** Coordinate to ensure a consistent interpretation methodology for the SHAP module (FR-07).
- **The Data Integrity Circle (A-10, B-11, C-9, C-27):** Ensure that the feature engineering pipeline (FR-03) follows the leakage-prevention best practices found in these papers.
